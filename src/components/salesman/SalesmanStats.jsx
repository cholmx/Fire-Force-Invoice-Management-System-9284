...
const SalesmanStats = () => {
  ...
  const stats = [
    ...
    { 
      ...
      link: '/salesman/invoices?status=pending'
    },
    { 
      title: 'Completed', 
      ...
      link: '/salesman/invoices?status=completed'
    }
  ];
      ...
      >
        {stats.map((stat, index) => (
          ...
          >
            <Link 
              to={stat.link}
              className="block bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200"
            >
